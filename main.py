...
with open('reizlaz2.txt', 'r', encoding = 'utf-8') as korpus: #otvara fajl na kojem se nalaze sve leme imenice za koje ce program da proveri jesu li prefigirane; poredjane po frekventnosti
    with open('glagoli.txt', 'r', encoding = 'utf-8') as fajl_sa_glagolima: #otvara fajl sa lemama glagola
        ...
        listainfinitivaimperf=['avati','evati','ivati','ovati']
        listainfinitivaperf=['ati','nuti','iti','eti']
            ...
            for prefiks in listaprefiksa:
                ...
                if rec.startswith(prefiks) and alomorf(prefiks) == True:  
                            ...
                            if len(osnova_bez_sufiksa_i_prefiksa) > 1:
                                ...
                                for nastavak_za_infinitiv in listainfinitiva: 
                                    ...
                                    if potencijalni_glagol in listaglagola:
                                        ...
                                        #U prvoj listi ce biti oni gde glagol bez prefiksa ostaje prefigiran
                                        #U drugoj ce biti reci kod kojih moze da se zameni prefiks
                                ...
                                if uslov==0:
                                    uslov=3
                                    break
                    #ovde proverava zavrsava li se rec na nulti sufiks.
                    if uslov == 0 and len(rec[len(prefiks):]) > 1: 
                        for nastavak_za_infinitiv in listainfinitiva:
                            rec_za_proveru = rec + nastavak_za_infinitiv
                            if rec_za_proveru in listaglagola:
                                if rec_za_proveru[len(prefiks):] in listaglagola:
                                    uslov = 41
                                    break
                                else:
                                    uslov=42
                    if uslov == 0:
                        ...
                        if uslov == 3 or uslov==32 or uslov==31:
                            print('naso'+ str(uslov))
                            return uslov, prefiks, sufiks, potencijalni_glagol
                        if uslov == 41 or uslov==42:
                            print('naso'+str(uslov))
                            return uslov, prefiks, rec_za_proveru
                        break
        with open('uslov1.txt', 'w', encoding = 'utf-8') as izlaz_1:
            with open('uslov2.txt', 'w', encoding = 'utf-8') as izlaz_2:
                with open('uslov3.txt', 'w', encoding = 'utf-8') as izlaz_3:
                        with open('uslov41.txt', 'w', encoding = 'utf-8') as izlaz_41:
                            with open('uslov32.txt', 'w', encoding = 'utf-8') as izlaz_32:
                                with open('uslov31.txt', 'w', encoding='utf-8') as izlaz_31:
                                    with open('uslov42.txt', 'w', encoding = 'utf-8') as izlaz_42:
                                        with open('uslov0.txt', 'w', encoding = 'utf-8') as izlaz_0:
                                            for rec in recnik:
                                                prefiksator(rec)
                                                if uslov == 1:
                                                ...
                                                if uslov == 41:
                                                    ...
                                                    izlaz_41.write(rec + ' : ' + prefiks + ' : -Ø : ' + rec_za_proveru + '\n')
                                                if uslov ==32:
                                                ...
                                                if uslov == 42:
                                                    ...
                                                    izlaz_42.write(rec + ' : ' + prefiks + ' : -Ø : ' + rec_za_proveru + '\n')
                                                if uslov == 0:
        
                                                    izlaz_0.write(rec + ' : ' + prefiks)
