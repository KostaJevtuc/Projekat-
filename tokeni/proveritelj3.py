...
from obraditelj1 import recnik
...
if __name__ == '__main__':
	...
	if pre.lower() == "da":
		...
		for rec,ponavljanja in recnik.items():
			prefiksator(rec, listaprefiksa, recnik, listasufiksa, listainfinitiva, listaglagola,ponavljanja)
