...
def prefiksator(rec, listaprefiksa, recnik, listasufiksa, listainfinitiva, listaglagola,ponavljanja):
    ...
    for prefiks in listaprefiksa:
        ...
        if rec.startswith(prefiks) and alomorf(prefiks, rec) == True:  
            ...
            if uslov == 1:
                print('nasao 1')
                with open('izlaz.txt', 'w', encoding = 'utf-8') as izlaz:
                    izlaz.write(prefiks + '\t'+  str(ponavljanja))
                    break
                ...
                # moze da prepozna da se rec zavrsava na vise sufiksa (npr. -ijacija i -a). 
                    ...
                    if uslov == 0:
                        ...
                        with open('uslov3.txt', 'a+', encoding = 'utf-8') as izlaz_3:
                            izlaz_3.write(rec + '\t' + prefiks + '\t'+  str(ponavljanja) + '\n')
                            break